        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    {!! Form::open(['route' => 'users.store','method' => 'POST','class' => 'form-horizontal','role' => 'form','id'=>'form','files' => true]) !!}
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4 offset-md-3">
                                <div class="card-box text-center" style="">
                                    <img src="{{asset('img/logged-user.jpg')}}" class="rounded-circle img-thumbnail"
                                         alt="profile-image"
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-6">
                                        {!! Form::password('password', ['class' => 'form-control ' . ($errors->has('password') ? ' is-invalid' : ''), 'placeholder' => __('Contraseña'),'required']) !!}
                                        @error('password')
                                        <span class="invalid-feedback" role="alert">
                                            {{ $message }}
                                        </span>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-6">
                                        {!! Form::password('password_confirmation', ['class' => 'form-control ' . ($errors->has('password_confirmation') ? ' is-invalid' : ''), 'placeholder' => __('Confirmar contraseña'),'required']) !!}
